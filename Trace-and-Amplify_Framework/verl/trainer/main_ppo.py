...
# from verl.utils.reward_score.livecodebench import compute_score_dynamic_penalty as code_compute_score
...
def main_task(config, compute_score=None):
    ...
    elif reward_manager_name == 'yr_penalty':
        from verl.workers.reward_manager import YRRewardManager_hacking_penalty
        reward_manager_cls = YRRewardManager_hacking_penalty
    else:
        raise NotImplementedError
    ...
    # print("DEBUG main_ppo val compute_score:", compute_score, callable(compute_score))
    # print("DEBUG main_ppo compute_score type:", type(compute_score))
