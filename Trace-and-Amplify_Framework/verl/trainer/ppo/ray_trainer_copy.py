                ...
                with _timer('step', timing_raw):
                    ...
                    if self.config.algorithm.adv_estimator == 'remax':
                        with _timer('gen_max', timing_raw):
                            ...
                            # print("DEBUG ray_trainer.fit remax batch:", batch) 
                            reward_baseline_tensor = self.reward_fn(batch)
                            print("DEBUG ray_trainer.fit remax reward_baseline_tensor:", reward_tensor)
                    ...
                    with _timer('adv', timing_raw):
                        ...
                        # print("DEBUG ray_trainer.fit batch:", batch)
                        reward_tensor = self.reward_fn(batch, global_training_steps=self.global_steps)    # for dynamic hacking example copy penalty
